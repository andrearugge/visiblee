  ...
  return (
    <PreviewResults
      data={{
        ...
        passageQualityScore: preview.passageQualityScore ?? 0,
        chunkabilityScore: preview.chunkabilityScore ?? 0,
        entityCoherenceScore: preview.entityCoherenceScore ?? 0,
        crossPlatformScore: preview.crossPlatformScore ?? 0,
